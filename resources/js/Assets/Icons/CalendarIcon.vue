<template>
    ...
    >
        <path d="M5 4c-1.105 0-2 .9-2 2v14c0 1.1.895 2 2 2h14c1.105 0 2-.9 2-2V6c0-1.1-.895-2-2-2H5z" fill="#bdc3c7"/>
        <path d="M5 3a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V5a2 2 0 0 0-2-2H5z" fill="#ecf0f1"/>
        <path d="M5 3a2 2 0 0 0-2 2v4h18V5a2 2 0 0 0-2-2H5z" fill="#e74c3c"/>
        <path d="M7.5 5.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 1 1 3 0z" fill="#c0392b"/>
        <path d="M6 1a1 1 0 0 0-1 1v3a1 1 0 1 0 2 0V2a1 1 0 0 0-1-1z" fill="#bdc3c7"/>
        <path d="M19.5 5.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 1 1 3 0z" fill="#c0392b"/>
        <g fill="#bdc3c7">
